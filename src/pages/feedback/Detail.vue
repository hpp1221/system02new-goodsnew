<template>
  <div class="container">
    <div class="wrapper">
      <el-button @click="returnList" style="float: right;margin-right: 30px;">返回</el-button>
      <el-form :model="ruleForm" ref="ruleForm" label-width="100px" class="demo-ruleForm" inline style="padding:50px">
        ...
        <el-form-item label="处理意见">
          <el-input type="textarea" v-model="ruleForm.sugRepMessage" style="width: 300px;" :disabled="true"></el-input>
        </el-form-item>
        <br>
      </el-form>
    </div>
