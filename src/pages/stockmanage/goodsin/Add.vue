	...
	<div class="container">
		<div class="wrapper">
			...
			<el-form ref="form" :model="form" :rules="rules" class="request-form" label-width="80px">
				...
				<el-form-item>
					<el-table :data="form.data" border>
						...
						<el-table-column label="商品编码  商品名称">
							<template scope="scope">
								<el-autocomplete v-on:click.native="handleClick(scope.$index)"
				...
				<el-form-item label="入库单号" prop="tradeNo">
					<el-input class="form-input" v-model="form.tradeNo"></el-input>
				</el-form-item>
				<el-form-item label="入库类型">
					<el-select class="form-input" v-model="form.type" placeholder="选择入库类型">
